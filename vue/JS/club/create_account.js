...
function deleteUser(target) {
    fetch('/auth/club/club_members', {
        ...
        .then((res) => {
            console.log(res);
            openModalConfirmCreate(res.deleted);
        });
}
...
function displayUsers() {
    ...
    btn_edit.forEach(function (button) {
        button.addEventListener("click", function (event) {
            ...
            document.querySelector(".pass_forgot").style.display = "flex";
            document.querySelector(".pass_forgot").querySelector("input").checked = false;
            ...
            document.querySelector("#firstname").value = get_user.firstname;
            document.querySelector("#lastname").value = get_user.lastname;
            document.querySelector("#birthdate").value = get_user.birthdate.split(" ")[0];
            ...
            document.querySelector("#licence_date").value = get_user.licenceExpiration.split(" ")[0];
            document.querySelector("#medic_date").value = get_user.medicalExpiration.split(" ")[0];
    ...
    list_user.forEach(function (user) {
        user.addEventListener("click", function (e) {
            if (!e.target.classList.contains("button")) {
                ...
                while (!clicked.classList.contains("user_item")) {
...
confirm_button.addEventListener("click", function () {
    ...
    if (confirm_button.innerHTML != "Modifier le compte") {
        ...
        document.querySelector("#validateButton_creation").addEventListener("click", function () {
            ...
            user_to_modify.forgotPassword = document.querySelector("#forgot_password").checked;
...
btn_create.addEventListener("click", function () {
    ...
    document.querySelector(".pass_forgot").style.display = "none";
